export function LoadingSkeleton() {
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#060b14_0%,#0a1320_45%,#08111b_100%)] text-white">
      <div className="mx-auto flex min-h-screen w-full max-w-295 flex-col gap-6 px-2 pb-12 pt-0 sm:px-3 lg:px-4">
        <div className="flex w-full flex-col gap-3 border-b border-white/10 bg-[linear-gradient(180deg,rgba(7,16,25,0.78),rgba(7,16,25,0.18))] px-5 py-4 backdrop-blur-md md:flex-row md:items-center md:justify-between md:gap-5 md:px-8">
        ...
        <div className="glass-panel relative mt-14 overflow-hidden rounded-4xl p-0 sm:mt-16">
          ...
          <div className="relative grid min-h-[calc(100vh-1rem)] items-end gap-6 px-3 py-12 sm:px-4 sm:py-14 lg:grid-cols-[minmax(0,1.15fr)_minmax(260px,0.85fr)] lg:px-5 lg:py-16">
            <div className="flex max-w-3xl flex-col gap-4 self-center">
              <div className="skeleton-line h-10 w-[27rem] max-w-full rounded-full" />
            ...
            <div className="grid gap-3 self-end lg:justify-self-end">
              <div className="skeleton-line h-44 w-full rounded-4xl lg:w-112" />
