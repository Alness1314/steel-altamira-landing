      ...
      <div className="grid items-center gap-4 lg:grid-cols-[1.05fr_minmax(0,0.95fr)]">
        <Reveal from="left" className="relative min-h-96 overflow-hidden rounded-4xl border border-white/10 bg-black/20">
          ...
          <div className="absolute left-5 top-5 rounded-full border border-white/12 bg-black/35 px-4 py-2 backdrop-blur-md sm:left-6 sm:top-6">
            <span className="font-display text-2xl font-extrabold text-white">20+</span>
            <span className="ml-2 text-xs uppercase tracking-[0.24em] text-white/65">anos de experiencia</span>
          </div>
